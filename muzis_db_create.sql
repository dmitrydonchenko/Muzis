...
CREATE TABLE users_artists (id bigint NOT NULL AUTO_INCREMENT, user_id varchar(100) NOT NULL, artist_id varchar(100) NOT NULL, FOREIGN KEY (user_id) REFERENCES users(id), FOREIGN KEY (artist_id) REFERENCES artists(id));
